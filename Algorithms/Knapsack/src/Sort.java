public class Sort {
    ...
    public static void MergeSort(item [] OriginalArray, int StartPoint, int EndPoint){
    ...
    public static void Merge(item [] OriginalArray, int StartPoint, int MidPoint, int EndPoint){
            // Create Two Array
        ...
        while (LeftArrayCounter < LeftArrayLength && RightArrayCounter < RightArrayLength){
            ...
            if(LeftArray[LeftArrayCounter].ratio < RightArray[RightArrayCounter].ratio){
